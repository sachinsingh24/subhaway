...
const servicesData = [
  {
    ...
    navLabel: 'Mind Power Unlimited',
    title: 'Mind Power Unlimited for Public',
    shortTitle: 'Mind Power Unlimited',
    icon: BookOpen,
  ...
  },
  {
    ...
    navLabel: 'Super Student Unlimited',
    title: 'Super Student Unlimited',
    shortTitle: 'Super Student Unlimited',
    icon: GraduationCap,
  ...
  },
  {
    ...
    navLabel: 'Unleash Corporate Power',
    title: 'Unleash the Power Within for Corporates',
    shortTitle: 'Corporate Power',
    icon: Building2,
